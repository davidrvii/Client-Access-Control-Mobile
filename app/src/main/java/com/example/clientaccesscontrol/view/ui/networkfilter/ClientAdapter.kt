...
class FilteredClientAdapter(
    private var listClient: List<FilteredClientsItem>,
) :
    RecyclerView.Adapter<FilteredClientAdapter.ViewHolder>() {

    class ViewHolder(private val binding: ClientListBinding) :
        RecyclerView.ViewHolder(binding.root) {

        fun bind(item: FilteredClientsItem) {
    ...
    fun updateData(newList: List<FilteredClientsItem>) {
