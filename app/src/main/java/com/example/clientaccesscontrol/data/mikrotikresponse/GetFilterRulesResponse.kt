...
data class GetFilterRulesResponse(

	@field:SerializedName("GetFilterRulesResponse")
	val getFilterRulesResponse: List<GetFilterRulesResponseItem?>? = null
)

data class GetFilterRulesResponseItem(
